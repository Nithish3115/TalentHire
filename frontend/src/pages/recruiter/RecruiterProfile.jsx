        ...
        <div className="max-w-3xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
            <div className="bg-white shadow overflow-hidden sm:rounded-lg border border-gray-200">
                <div className="px-4 py-5 sm:px-6 bg-gray-50 border-b border-gray-200">
                    <h3 className="text-lg leading-6 font-medium text-gray-900">Company & Recruiter Profile</h3>
                    <p className="mt-1 max-w-2xl text-sm text-gray-500">Update your company details and contact information.</p>
                </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                            <div className="sm:col-span-2">
                                <label htmlFor="email" className="block text-sm font-medium text-gray-700">Account Email (Read Only)</label>
                                <input
                                    type="email"
                                    name="email"
                                    id="email"
